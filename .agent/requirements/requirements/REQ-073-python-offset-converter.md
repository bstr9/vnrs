...
### Python 接口
- [ ] PyOffsetConverter 类暴露 convert_order_request() 方法
- [ ] Python 可查询某合约是否需要今昨仓拆分
- [ ] Python 可查询当前今仓/昨仓持仓量
- [ ] Python 通过 engine.offset_converter 访问

### 集成
- [ ] MainEngine.send_order() 自动转换对 Python 透明
- [ ] Python 策略可手动调用 OffsetConverter 预览拆单结果
