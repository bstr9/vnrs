---
id: REQ-029
title: "Python cancel_stop_order 方法"
status: deprecated
...
versions:
  - version: 1
    ...
    author: ai
    context: "代码分析发现 Rust BaseStrategy 有 cancel_stop_order 方法，Python Strategy 未暴露。"
    reason: "策略需要能取消已发送的止损单"
    snapshot: "Python Strategy 添加 cancel_stop_order 方法"
  - version: 2
