...
impl LmdbDatabase {
    ...
    pub fn new(path: &str) -> Result<Self, String> {
        std::fs::create_dir_all(path)
            .map_err(|e| format!("Failed to create LMDB directory {}: {}", path, e))?;
        ...
        let env = unsafe {
            EnvOpenOptions::new()
                ...
                .max_dbs(8)
                .open(path)
                .map_err(|e| format!("Failed to open LMDB environment at {}: {}", path, e))?
        };
        ...
        env.create_database::<Bytes, Bytes>(&mut wtxn, Some("bars"))
            .map_err(|e| format!("Failed to create bars database: {}", e))?;
        env.create_database::<Bytes, Bytes>(&mut wtxn, Some("ticks"))
            .map_err(|e| format!("Failed to create ticks database: {}", e))?;
        env.create_database::<Bytes, Bytes>(&mut wtxn, Some("orders"))
            .map_err(|e| format!("Failed to create orders database: {}", e))?;
        env.create_database::<Bytes, Bytes>(&mut wtxn, Some("trades"))
            .map_err(|e| format!("Failed to create trades database: {}", e))?;
        env.create_database::<Bytes, Bytes>(&mut wtxn, Some("positions"))
            .map_err(|e| format!("Failed to create positions database: {}", e))?;
        env.create_database::<Bytes, Bytes>(&mut wtxn, Some("events"))
            .map_err(|e| format!("Failed to create events database: {}", e))?;
    ...
    fn deserialize_bar(value: &[u8]) -> Result<BarData, String> {
        serde_json::from_slice(value).map_err(|e| format!("Failed to deserialize BarData: {}", e))
    }

    fn deserialize_tick(value: &[u8]) -> Result<TickData, String> {
        serde_json::from_slice(value).map_err(|e| format!("Failed to deserialize TickData: {}", e))
    }

    fn deserialize_order(value: &[u8]) -> Result<OrderData, String> {
        serde_json::from_slice(value).map_err(|e| format!("Failed to deserialize OrderData: {}", e))
    }

    fn deserialize_trade(value: &[u8]) -> Result<TradeData, String> {
        serde_json::from_slice(value).map_err(|e| format!("Failed to deserialize TradeData: {}", e))
    }

    fn deserialize_position(value: &[u8]) -> Result<PositionData, String> {
        serde_json::from_slice(value).map_err(|e| format!("Failed to deserialize PositionData: {}", e))
    }
}
...
impl BaseDatabase for LmdbDatabase {
    async fn save_bar_data(&self, bars: Vec<BarData>, _stream: bool) -> Result<bool, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let db: Database<Bytes, Bytes> = env
                ...
                .map_err(|e| format!("Failed to open bars database: {}", e))?
                .ok_or_else(|| "bars database not found".to_string())?;
            ...
            for bar in &bars {
                ...
                let value = serde_json::to_vec(bar)
                    .map_err(|e| format!("Failed to serialize BarData: {}", e))?;
                db.put(&mut wtxn, &key, &value)
                    .map_err(|e| format!("Failed to put bar data: {}", e))?;
            }

            wtxn.commit()
                .map_err(|e| format!("Failed to commit bar data: {}", e))?;
            Ok(true)
        })
        .await
    ...
    async fn save_tick_data(&self, ticks: Vec<TickData>, _stream: bool) -> Result<bool, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let db: Database<Bytes, Bytes> = env
                ...
                .map_err(|e| format!("Failed to open ticks database: {}", e))?
                .ok_or_else(|| "ticks database not found".to_string())?;

            for tick in &ticks {
                let key = Self::tick_key(&tick.exchange, &tick.symbol, tick.datetime.timestamp());
                let value = serde_json::to_vec(tick)
                    .map_err(|e| format!("Failed to serialize TickData: {}", e))?;
                db.put(&mut wtxn, &key, &value)
                    .map_err(|e| format!("Failed to put tick data: {}", e))?;
            }

            wtxn.commit()
                .map_err(|e| format!("Failed to commit tick data: {}", e))?;
            Ok(true)
        })
        .await
        .map_err(|e| format!("spawn_blocking error: {}", e))?
    ...
    async fn load_bar_data(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let iter = db
                ...
                .map_err(|e| format!("Failed to create bar range iterator: {}", e))?;

            let mut result = Vec::new();
            for item in iter {
                let (key, value) = item.map_err(|e| format!("Failed to read bar entry: {}", e))?;
    ...
    async fn load_tick_data(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let iter = db
                .range(&rtxn, &(Bound::Included(range_start.as_slice()), Bound::Excluded(range_end.as_slice())))
                .map_err(|e| format!("Failed to create tick range iterator: {}", e))?;

            let mut result = Vec::new();
            for item in iter {
                let (key, value) = item.map_err(|e| format!("Failed to read tick entry: {}", e))?;
                if let Some(pos) = key.iter().rposition(|&b| b == 0) {
                    let ts_bytes = &key[pos + 1..];
                    if ts_bytes.len() == 8 {
                        let ts = i64::from_be_bytes(ts_bytes.try_into().unwrap_or([0u8; 8]));
    ...
    async fn delete_bar_data(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let deleted = db
                ...
                .map_err(|e| format!("Failed to delete bar data range: {}", e))?;
    ...
    async fn delete_tick_data(&self, symbol: &str, exchange: Exchange) -> Result<i64, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let deleted = db
                .delete_range(&mut wtxn, &(Bound::Included(prefix.as_slice()), Bound::Excluded(range_end.as_slice())))
                .map_err(|e| format!("Failed to delete tick data range: {}", e))?;
    ...
    async fn get_bar_overview(&self) -> Result<Vec<BarOverview>, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let iter = db
                .iter(&rtxn)
                .map_err(|e| format!("Failed to create bar iterator: {}", e))?;

            let mut groups: HashMap<(String, Exchange, Interval), Vec<BarData>> = HashMap::new();

            for item in iter {
                let (_key, value) = item.map_err(|e| format!("Failed to read bar entry: {}", e))?;
                let bar = Self::deserialize_bar(value)?;
                let interval = bar.interval.unwrap_or(Interval::Minute);
    ...
    async fn get_tick_overview(&self) -> Result<Vec<TickOverview>, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let iter = db
                .iter(&rtxn)
                .map_err(|e| format!("Failed to create tick iterator: {}", e))?;

            let mut groups: HashMap<(String, Exchange), Vec<TickData>> = HashMap::new();

            for item in iter {
                let (_key, value) = item.map_err(|e| format!("Failed to read tick entry: {}", e))?;
                let tick = Self::deserialize_tick(value)?;
    ...
    async fn save_order_data(&self, orders: Vec<OrderData>) -> Result<bool, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let db: Database<Bytes, Bytes> = env
                ...
                .map_err(|e| format!("Failed to open orders database: {}", e))?
                .ok_or_else(|| "orders database not found".to_string())?;

            for order in &orders {
                let key = order.vt_orderid();
                let value = serde_json::to_vec(order)
                    .map_err(|e| format!("Failed to serialize OrderData: {}", e))?;
                db.put(&mut wtxn, key.as_bytes(), &value)
                    .map_err(|e| format!("Failed to put order data: {}", e))?;
            }

            wtxn.commit()
                .map_err(|e| format!("Failed to commit order data: {}", e))?;
            Ok(true)
        })
        .await
        .map_err(|e| format!("spawn_blocking error: {}", e))?
    ...
    async fn save_trade_data(&self, trades: Vec<TradeData>) -> Result<bool, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let db: Database<Bytes, Bytes> = env
                ...
                .map_err(|e| format!("Failed to open trades database: {}", e))?
                .ok_or_else(|| "trades database not found".to_string())?;

            for trade in &trades {
                let key = trade.vt_tradeid();
                let value = serde_json::to_vec(trade)
                    .map_err(|e| format!("Failed to serialize TradeData: {}", e))?;
                db.put(&mut wtxn, key.as_bytes(), &value)
                    .map_err(|e| format!("Failed to put trade data: {}", e))?;
            }

            wtxn.commit()
                .map_err(|e| format!("Failed to commit trade data: {}", e))?;
            Ok(true)
        })
        .await
        .map_err(|e| format!("spawn_blocking error: {}", e))?
    ...
    async fn save_position_data(&self, positions: Vec<PositionData>) -> Result<bool, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let db: Database<Bytes, Bytes> = env
                ...
                .ok_or_else(|| "positions database not found".to_string())?;

            for position in &positions {
                let key = position.vt_positionid();
                let value = serde_json::to_vec(position)
                    .map_err(|e| format!("Failed to serialize PositionData: {}", e))?;
                db.put(&mut wtxn, key.as_bytes(), &value)
                    .map_err(|e| format!("Failed to put position data: {}", e))?;
            }

            wtxn.commit()
                .map_err(|e| format!("Failed to commit position data: {}", e))?;
            Ok(true)
        })
        .await
        .map_err(|e| format!("spawn_blocking error: {}", e))?
    ...
    async fn save_event(&self, event: EventRecord) -> Result<bool, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let db: Database<Bytes, Bytes> = env
                ...
                .ok_or_else(|| "events database not found".to_string())?;

            let key = Self::event_key(event.event_id);
            let value = serde_json::to_vec(&event)
                .map_err(|e| format!("Failed to serialize EventRecord: {}", e))?;
            db.put(&mut wtxn, &key, &value)
                .map_err(|e| format!("Failed to put event data: {}", e))?;

            wtxn.commit()
                .map_err(|e| format!("Failed to commit event data: {}", e))?;
            Ok(true)
        })
        .await
        .map_err(|e| format!("spawn_blocking error: {}", e))?
    ...
    async fn load_orders(&self, gateway_name: Option<&str>) -> Result<Vec<OrderData>, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let iter = db
                .iter(&rtxn)
                .map_err(|e| format!("Failed to create orders iterator: {}", e))?;

            let mut result = Vec::new();
            for item in iter {
                let (_key, value) = item.map_err(|e| format!("Failed to read order entry: {}", e))?;
    ...
    async fn load_trades(&self, gateway_name: Option<&str>) -> Result<Vec<TradeData>, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let iter = db
                .iter(&rtxn)
                .map_err(|e| format!("Failed to create trades iterator: {}", e))?;

            let mut result = Vec::new();
            for item in iter {
                let (_key, value) = item.map_err(|e| format!("Failed to read trade entry: {}", e))?;
    ...
    async fn load_positions(&self, gateway_name: Option<&str>) -> Result<Vec<PositionData>, String> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let iter = db
                .iter(&rtxn)
                .map_err(|e| format!("Failed to create positions iterator: {}", e))?;

            let mut result = Vec::new();
            for item in iter {
                let (_key, value) = item.map_err(|e| format!("Failed to read position entry: {}", e))?;
