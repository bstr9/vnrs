...
fn default_settings() -> HashMap<String, SettingValue> {
    ...
    settings.insert(
        ...
        SettingValue::String("微软雅黑".to_string()),
    );
    ...
    settings.insert(
        ...
        SettingValue::String("smtp.qq.com".to_string()),
    );
    ...
    // Database settings
    settings.insert(
        "database.timezone".to_string(),
        SettingValue::String("UTC".to_string()),
    );
    settings.insert(
        "database.name".to_string(),
        SettingValue::String("sqlite".to_string()),
    );
    settings.insert(
        "database.database".to_string(),
        SettingValue::String("database.db".to_string()),
    );
    settings.insert(
    ...
    settings.insert(
        "language".to_string(),
        SettingValue::String("zh_CN".to_string()),
    );
