...
impl TradingMcpServer {
    ...
    pub fn with_sampling_config(
        ...
        let router = Self::trading_router()
            + Self::ui_router()
            + Self::market_router()
            + Self::account_router()
    ...
    fn get_info(&self) -> ServerInfo {
        ...
        .with_instructions(
            "Trading system MCP server with 50+ tools across 8 categories. \
             \n\n**Trading tools**: connect, subscribe, send_order, cancel_order, query_history, list_contracts, analyze_sentiment, disconnect, unsubscribe, modify_order, batch_orders, close_position, set_leverage, get_order_status. \
             ...
             \n\nThe analyze_sentiment tool uses MCP Sampling to request LLM-powered sentiment analysis. \
             ...
             \n\n**Prompts**: pre_trade_check, risk_assessment, position_analysis, market_overview, strategy_review.".to_string(),
        )
    }
